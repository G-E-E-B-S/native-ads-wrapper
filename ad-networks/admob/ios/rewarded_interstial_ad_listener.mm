#import "rewarded_interstial_ad_listener.h"

@implementation RewardedInterstialAdListener
- (id)init {
    self = [super init];
...
- (void)load:(NSString *)adUnitId listener: (std::shared_ptr<RewardedInterstitialVideoListener>) listener {
