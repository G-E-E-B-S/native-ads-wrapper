...
@interface RewardedAdListener : NSObject <GADFullScreenContentDelegate> {
@private
...
- (void) load:(NSString*_Nonnull) adUnitId listener: (std::shared_ptr<RewardedVideoListener>) listener;
- (void)show;
